/*************************************************************************
	...
	> Created Time: Sat 29 Mar 2014 04:57:36 PM CST
 ************************************************************************/

#include"chat.h"
int main(int argc , char *argv[])
{
	int fd_31 , fd_32 , fd_13 , fd_23 ;
	...
	if(fd_13 == -1 || fd_31 ==-1 ||fd_23 == -1 || fd_32 ==-1)
	{
		perror("open:");
		exit(-1);
	}
	...
	else if(pid == 0)
	{
		while(1)
		{
			...
			bzero(cmd , 128);
			fd_rd_back = fd_rd ;
			select(fd_13 > fd_23 ? fd_13+1 : fd_23+1 , &fd_rd_back , NULL ,NULL , &tm);
			if(FD_ISSET(fd_13 , &fd_rd_back))
			{
				//从cli2中读出内容
				ired = read(fd_13 , buf , 128);
